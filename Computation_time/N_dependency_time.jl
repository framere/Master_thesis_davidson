...
logfile = open("Computation_time/data_iterations_N.txt", "w")
for N in [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 4000, 8000, 10000, 12000, 16000]
    println("N = $N")
    iterations, elapsed_time = main(N)
